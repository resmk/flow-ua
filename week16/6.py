...
def create_color_legend():
    return html.Div([
        ...
        html.Div([html.Span("⬤", style={"color": "green", "marginRight": "6px"}),
                  html.Span("Path 1", style={"fontSize": "14px"})], style={"marginBottom": "6px"}),
        html.Div([html.Span("⬤", style={"color": "blue", "marginRight": "6px"}),
                  html.Span("Path 2", style={"fontSize": "14px"})], style={"marginBottom": "6px"}),
        html.Div([html.Span("⬤", style={"color": "orange", "marginRight": "6px"}),
                  html.Span("Path 3", style={"fontSize": "14px"})], style={"marginBottom": "6px"}),
        html.Div([html.Span("⬤", style={"color": "purple", "marginRight": "6px"}),
                  html.Span("Path 4", style={"fontSize": "14px"})], style={"marginBottom": "6px"}),
        html.Div([html.Span("⬤", style={"color": "cyan", "marginRight": "6px"}),
                  html.Span("Path 5", style={"fontSize": "14px"})], style={"marginBottom": "6px"}),
        html.Div([html.Span("⬤", style={"color": "brown", "marginRight": "6px"}),
                  html.Span("Path 6", style={"fontSize": "14px"})], style={"marginBottom": "6px"}),
        html.Div([html.Span("⬤", style={"color": "magenta", "marginRight": "6px"}),
...
def unified_callback(jump_source, jump_aim, restore, budgeted_attack_clicks, show_attack, multi_step_attack_click,
    ...
    # ---------- SHOW ATTACKED EDGES (paths view) ----------
        ...
        # Use numeric labels in the path info text
        ...
        for i, (path_edges, attacked_uv, color) in enumerate(colored_paths_info):
            ...
            # map ids to original numeric labels for display
            full_path_text = " → ".join(display_node_label(n) for n in full_path_nodes)
            attacked_text = f"{display_node_label(attacked_uv[0])} → {display_node_label(attacked_uv[1])}"
            ...
            path_info_children.append(
                html.Div([
                    ...
                    html.P(full_path_text, style={"fontSize": "13px", "marginLeft": "12px"})
                ])
            )
