# show the attacked edges and their path to source and aim node.
...
app.layout = html.Div([
    ...
    html.Button("Back to Main Graph", id="back-main-btn", n_clicks=0, style={
        "position": "absolute", "top": "60px", "left": "20px", "zIndex": 11
    }),
    ...
    html.Button("Jump to Aim (N100)", id="jump-aim-btn", n_clicks=0,
                style={"position": "absolute", "top": "140px", "left": "20px", "zIndex": 11}),
    ...
    html.Button("Show Attacked Edges", id="show-attack-btn", n_clicks=0, style={
        "position": "absolute", "top": "220px", "left": "20px", "zIndex": 11
    }),
