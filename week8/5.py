...
# Ensure every node except N1 has at least one incoming edge
for node in G.nodes:
...
# Additional Dash app layout features like color legend, loader, and frontend normalization can now be added
# ----------- Dash App Setup -----------
external_scripts = [
